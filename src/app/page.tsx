...
export default function HomePage() {
    return (
        <div className="min-h-screen bg-[#FFFFFF]">
            <nav className="border-b border-[#D1D5DB]">
                <div className="max-w-6xl mx-auto px-8 py-6 flex justify-between items-center">
                    <div className="text-2xl font-light text-[#1A1A1A]">Cruel</div>
                    <div className="flex gap-8">
                        <Link
                            href="/login"
                            className="text-[#6B7280] hover:text-[#1A1A1A] transition-colors font-light"
                        >
                            Sign In
                        </Link>
                        <Link
            ...
            <section className="max-w-3xl mx-auto px-8 py-32 text-center">
                <h1 className="text-6xl font-light text-[#1A1A1A] mb-8 tracking-tight">
                    Never Miss a Deadline
                </h1>
                <p className="text-lg font-light text-[#6B7280] mb-16 max-w-xl mx-auto leading-relaxed">
            ...
            <section className="max-w-4xl mx-auto px-8 py-24 border-t border-[#D1D5DB]">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                    <div className="text-center">
                        <Calendar
                            className="w-6 h-6 text-[#2563EB] mx-auto mb-6"
                            strokeWidth={1.5}
                        />
                        <h3 className="text-lg font-light mb-3 text-[#1A1A1A]">Track Deadlines</h3>
                    ...
                    <div className="text-center">
                        <MessageSquare
                            ...
                            strokeWidth={1.5}
                        />
                        <h3 className="text-lg font-light mb-3 text-[#1A1A1A]">WhatsApp Sync</h3>
                        <p className="text-sm font-light text-[#6B7280] leading-relaxed">
                            Extract deadlines automatically
                        </p>
                    </div>
                    <div className="text-center">
                        <Bell className="w-6 h-6 text-[#2563EB] mx-auto mb-6" strokeWidth={1.5} />
                        <h3 className="text-lg font-light mb-3 text-[#1A1A1A]">Smart Alerts</h3>
                        <p className="text-sm font-light text-[#6B7280] leading-relaxed">
            ...
            <section className="border-t border-[#D1D5DB] py-24">
